...
<!--<script type="text/javascript" src="<?php echo \Idno\Core\site()->config()->url ?>IdnoPlugins/Checkin/external/stamen-maps/tile.stamen.js"></script>-->
<script type="text/javascript" src="<?php echo \Idno\Core\site()->config()->url ?>IdnoPlugins/Checkin/external/leaflet-providers/leaflet-providers.js"></script>
